...
router.get('/get_recommended_roommates', jsonParser, (req, res) => {
...
router.post('/save_search_history', jsonParser, (req,res)=>{
...
router.post('/get_listings_by_filter', jsonParser, (req, res) => {
