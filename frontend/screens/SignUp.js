    ...
    return (
      <ScrollView
        ...
        <View style={styles.columncontainer}>
          <Button style={styles.buttons} color='#BA55D3' testID="signup_button" title="Sign Up!" onPress={() => this.checkPasswords(this.state.passwordField, this.state.passwordConfirm)} />
